<x-public-layout>
    ...
    >
        <div class="flex flex-col gap-6 sm:gap-10 items-start text-off-white w-full">
            <div class="flex flex-col gap-4 items-start w-full" data-aos="fade-up" data-aos-duration="750">
                ...
                <p class="font-sans font-normal text-sm sm:text-base md:text-lg leading-relaxed sm:leading-[27px] tracking-[-0.3px] w-full max-w-[746px] text-off-white/95">
    ...
    <section class="bg-white flex flex-col items-center container py-16 sm:py-24 lg:py-[120px] w-full">
        <div class="flex flex-col gap-10 sm:gap-[60px] items-center justify-center w-full">
            <h2 class="font-heading font-bold text-3xl sm:text-4xl md:text-5xl lg:text-[64px] leading-tight lg:leading-[75px] tracking-[-2.3px] capitalize text-charcoal text-center w-full max-w-[900px] px-2" data-aos="fade-up" data-aos-duration="700">
    ...
    <section class="bg-white flex flex-col items-center container py-16 sm:py-24 lg:py-[120px] w-full">
        <div class="flex flex-col lg:flex-row gap-10 lg:gap-16 items-center w-full justify-center">
            ...
            <div class="flex flex-col gap-6 sm:gap-8 items-start w-full max-w-[652px] order-1 lg:order-2" data-aos="fade-up" data-aos-duration="700">
                ...
                <div class="flex flex-col gap-4 items-start text-body-gray font-sans font-normal text-sm sm:text-base md:text-lg leading-relaxed sm:leading-[27px] tracking-[-0.3px] w-full">
                    <p class="w-full">
        ...
        <div class="flex flex-col lg:flex-row gap-10 lg:gap-16 items-start w-full">
            <div class="flex flex-col gap-10 sm:gap-[60px] items-start w-full max-w-[628px] lg:flex-1" data-aos="fade-up" data-aos-duration="700">
                ...
                <div class="flex flex-col gap-6 sm:gap-8 items-start w-full">
                    <h3 class="font-heading font-bold text-xl sm:text-2xl md:text-[32px] leading-tight sm:leading-[42px] tracking-[-0.5px] text-charcoal w-full max-w-[518px]">
                        Events We Cover:
                    </h3>
                    <ul class="flex flex-col gap-4 sm:gap-5 items-start list-none p-0 m-0 w-full">
                        @foreach ([
                            ...
                            <li class="flex gap-3 items-start w-full">
                                ...
                                <span class="font-sans font-medium text-sm sm:text-base leading-6 tracking-[-0.3px] text-charcoal flex-1 min-w-0">
                                    {{ $line }}
                                </span>
                            </li>
                        @endforeach
