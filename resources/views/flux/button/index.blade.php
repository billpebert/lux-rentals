...
$classes = Flux::classes()
    ...
    ->add(match ($size) { // Size...
        'lg' => 'h-14 text-base rounded-lg' . ' ' . ($square ? 'w-14' : 'px-6'),
    ...
    ->add($inset ? match ($size) { // Inset...
        'lg' => $square
            ? Flux::applyInset($inset, top: '-mt-3.5', right: '-me-3.5', bottom: '-mb-3.5', left: '-ms-3.5')
            : Flux::applyInset($inset, top: '-mt-3.5', right: '-me-6', bottom: '-mb-3.5', left: '-ms-6'),
        'base' => $square
    ...
    ->add(match ($variant) { // Background color...
        ...
        'outline-primary' => 'bg-transparent hover:bg-zinc-800/5 dark:hover:bg-zinc-600/75',
    })
    ->add(match ($variant) { // Text color...
        ...
        'outline-primary' => 'text-[var(--color-accent)] dark:text-[var(--color-accent)]',
    })
    ...
    ->add(match ($variant) { // Grouped border treatments...
        ...
        'outline-primary' => '[[data-flux-button-group]_&]:border-s-0 [:is([data-flux-button-group]>&:first-child,_[data-flux-button-group]_:first-child>&)]:border-s-[1px]',
